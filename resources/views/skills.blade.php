                            ...
                            <div class="row">
                                <div class="set-size charts-container col-xs-12">
                                    <div class="pie-wrapper progress-60 ">
                                      ...
                                      <span class="additional" style="font-size: 20px; position: absolute; right: 20px; top: -30px;">English</span>
                                    </div>
                                    ...
                                    <div class="pie-wrapper progress-90"> 
                                      ...
                                      <span class="additional" style="font-size: 20px; position: absolute; right: 20px; top: -30px;">Teamwork</span>
                                    </div>
                                    ...
                                    <div class="pie-wrapper progress-75 style-2">
                                      ...
                                      <span class="additional" style="font-size: 20px; position: absolute; right: 20px; top: -30px; text-align: center;">Creativiy</span>
                        ...
                        <ul class="ul-education">
                            <li class="li-university">
                                <div class="university">
                                    ...
                                    <span class="university-name">School №33</span>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="education-content">
                        ...
                        <ul class="ul-education">
                            <li class="li-university">
                                <div class="university">
                                    <span class="education-icon"><i class="fa fa-university"></i></span>
                                    <span class="university-name">Abai school-gymnasium</span>
                                </div>
                            </li>
                        </ul>
                        <p class="prg-education">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    ...
                    <div class="education-content">
                        ...
                        <ul class="ul-education">
                            <li class="li-university">
                                <div class="university">
                                    <span class="education-icon"><i class="fa fa-university"></i></span>
                                    <span class="university-name">Suleyman Demirel University</span>
                                </div>
                            </li>
                        </ul>
                        <p class="prg-education">Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
